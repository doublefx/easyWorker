...
public class WorkerUsingEmbeds implements Runnable{
    /**
    ...
    public function run(args:Array):void {
        try {
            const embedVO:WithEmbedVO = args[0] as WithEmbedVO;
            const helloWorldAsset:ByteArrayAsset = embedVO.helloWorldAsset;
