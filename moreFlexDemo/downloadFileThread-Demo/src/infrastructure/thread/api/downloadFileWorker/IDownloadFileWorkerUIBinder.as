...
public interface IDownloadFileWorkerUIBinder {
    function get downloader():IDownloader;

    function set downloader(v:IDownloader):void;

    function onProgress(event:ThreadProgressEvent):void;

    function onError(event:ThreadFaultEvent):void;

    function onCompleted(event:ThreadResultEvent):void;
}
}